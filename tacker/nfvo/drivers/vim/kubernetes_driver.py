...
class Kubernetes_Driver(abstract_vim_driver.VimAbstractDriver):
    ...
    def discover_placement_attr(self, vim_obj):
        ...
        Attributes can include regions, AZ, namespace.
        """
        # placement_attr is replaced by namespace in Kubernetes environment
        # which is used to match with the existing VIM database and
        # Tacker horizon
        vim_obj['placement_attr'] = {
            "regions": [vim_obj['vim_project']['name']]}
        return vim_obj
